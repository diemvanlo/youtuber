...
class Article extends Component {
  ...
  render() {
    ...
    const article = navigation.getParam('article');
    console.log(article);
    // const url = article.url.toString.replace("https://www.youtube.com/watch?v=", "https://www.youtube.com/embed/");
    var SampleText = article.url.toString();

    // var NewText = SampleText.replace("https://www.youtube.com/watch?v=", "https://www.youtube.com/embed/");
    let myStr =  article.url.toString();
    console.log(myStr);
    console.log(myStr.replace("http://www.youtube.com/watch?v=", "https://www.youtube.com/embed/"));
    return (
      <View style={styles.flex}>
        ...
        <View style={[styles.flex, styles.content]}>
          <View style={[styles.flex, styles.contentHeader]}>
            <Image style={[styles.avatar, styles.shadow]} source={{ uri: article.thumb }} />
